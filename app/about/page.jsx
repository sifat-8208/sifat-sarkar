...
export default function About() {
    return (
        <div id="about" className="pt-32">
          ...
          <div className="grid grid-cols-auto px-5">

            <div>
                <div className="flex items-center gap-3">
                    <Image alt="" src={assets.code_icon} className="w-6"/>
                    <h2 className="text-xl" id="lang">Language that I used</h2>
                </div>
            ...
            <div>
                ...
                <div className="flex items-center gap-3">
                    <Image alt="" src={assets.edu_icon} className="w-6"/>
                    <h2 className="text-xl" id="cybersecurity">What is Cybersecurity</h2>
                </div>
                <p className="text-sm pl-10 lg:text-lg">
                In the digital age, safeguarding your data and systems is essential. I specialize in providing comprehensive cybersecurity solutions, including vulnerability assessments, penetration testing, and proactive defense strategies to protect your business from cyber threats. With a focus on securing web applications and networks, I ensure your digital assets remain safe and resilient against evolving attacks. Let’s work together to fortify your cybersecurity posture. 

                <Link href='/services' className="pl-5 text-gray-700 dark:text-white/80">See More...</Link>
                </p>
            </div>
          </div>
        </div>
